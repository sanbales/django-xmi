...
class FlowDirection(Enumeration):
    ...
    flow_direction = models.CharField(max_length=255, choices=CHOICES, default=IN)
...
class Refine(DirectedRelationshipPropertyPath):
    ...
    def __init__(self, *args, **kwargs):
        super(Refine).__init__(*args, **kwargs)
...
class Trace(DirectedRelationshipPropertyPath):
    ...
    def __init__(self, *args, **kwargs):
        super(Trace).__init__(*args, **kwargs)
...
class Allocate(DirectedRelationshipPropertyPath):
    ...
    def __init__(self, *args, **kwargs):
        super(Allocate).__init__(*args, **kwargs)
...
class TriggerOnNestedPort(ElementPropertyPath):
    ...
    def __init__(self, *args, **kwargs):
        super(TriggerOnNestedPort).__init__(*args, **kwargs)
    pass
...
class InvocationOnNestedPortAction(ElementPropertyPath):
    ...
    def __init__(self, *args, **kwargs):
        super(InvocationOnNestedPortAction).__init__(*args, **kwargs)
    pass
