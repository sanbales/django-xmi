...
class Stakeholder(models.Model):
    ...
    base_classifier = models.ForeignKey('Classifier')
...
class ChangeStructuralFeatureEvent(models.Model):
    ...
    stereotype = models.OneToOneField('Stereotype')
    base_change_event = models.ForeignKey('ChangeEvent')
...
class ParticipantProperty(models.Model):
    ...
    stereotype = models.OneToOneField('Stereotype')
    base_property = models.ForeignKey('Property')
...
class Optional(models.Model):
    ...
    stereotype = models.OneToOneField('Stereotype')
    base_parameter = models.ForeignKey('Parameter')
...
class ItemFlow(models.Model):
    ...
    stereotype = models.OneToOneField('Stereotype')
    base_information_flow = models.ForeignKey('InformationFlow')
...
class Block(models.Model):
    ...
    stereotype = models.OneToOneField('Stereotype')
    base_class = models.ForeignKey('Class')
...
class DirectedRelationshipPropertyPath(models.Model):
    ...
    stereotype = models.OneToOneField('Stereotype')
    base_directed_relationship = models.ForeignKey('DirectedRelationship')
...
class ElementPropertyPath(models.Model):
    ...
    stereotype = models.OneToOneField('Stereotype')
    base_element = models.ForeignKey('Element')
...
class FullPort(models.Model):
    ...
    stereotype = models.OneToOneField('Stereotype')
    base_port = models.ForeignKey('Port')
...
class Expose(models.Model):
    ...
    stereotype = models.OneToOneField('Stereotype')
    base_dependency = models.ForeignKey('Dependency')
...
class NoBuffer(models.Model):
    ...
    stereotype = models.OneToOneField('Stereotype')
    base_object_node = models.ForeignKey('ObjectNode')
...
class Rate(models.Model):
    ...
    stereotype = models.OneToOneField('Stereotype')
    base_activity_edge = models.ForeignKey('ActivityEdge')
    base_object_node = models.ForeignKey('ObjectNode')
    base_parameter = models.ForeignKey('Parameter')
...
class VerdictKind(models.Model):
    ...
    verdict_kind = models.IntegerField(choices=CHOICES, default=INCONCLUSIVE)
...
class ControlOperator(models.Model):
    ...
    stereotype = models.OneToOneField('Stereotype')
    base_behavior = models.ForeignKey('Behavior')
    base_operation = models.ForeignKey('Operation')
...
class ValueType(models.Model):
    ...
    stereotype = models.OneToOneField('Stereotype')
    base_data_type = models.ForeignKey('DataType')
...
class AllocateActivityPartition(models.Model):
    ...
    stereotype = models.OneToOneField('Stereotype')
    base_activity_partition = models.ForeignKey('ActivityPartition')
...
class AcceptChangeStructuralFeatureEventAction(models.Model):
    ...
    stereotype = models.OneToOneField('Stereotype')
    base_accept_event_action = models.ForeignKey('AcceptEventAction')
...
class Probability(models.Model):
    ...
    stereotype = models.OneToOneField('Stereotype')
    base_activity_edge = models.ForeignKey('ActivityEdge')
    base_parameter_set = models.ForeignKey('ParameterSet')
...
class DirectedFeature(models.Model):
    ...
    stereotype = models.OneToOneField('Stereotype')
    base_feature = models.ForeignKey('Feature')
...
class Conform(models.Model):
    ...
    stereotype = models.OneToOneField('Stereotype')
    base_generalization = models.ForeignKey('Generalization')
...
class BindingConnector(models.Model):
    ...
    stereotype = models.OneToOneField('Stereotype')
    base_connector = models.ForeignKey('Connector')
